...
$credentials = new Credentials(
    $servicesCredentials['nokiaHealth']['key'],
    $servicesCredentials['nokiaHealth']['secret'],
    $currentUri->getAbsoluteUri()
);

// Instantiate the Facebook service using the credentials, http client and storage mechanism for the token
/** @var $facebookService Facebook */
$facebookService = $serviceFactory->createService('nokiaHealth', $credentials, $storage, array());
...
if (!empty($_GET['code'])) {
    ...
    echo 'Your unique nokiaHealth user id is: ' . $result['id'] . ' and your name is ' . $result['name'];
